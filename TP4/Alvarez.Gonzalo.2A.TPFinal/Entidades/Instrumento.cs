...
namespace Entidades
{
    public class Instrumento : Producto
    {
        ...
        #region Propiedades
        /// <summary>
        /// Propiedad TipoInstrumento, retorna un string dependiendo el valor del atributo tipoInstrumento 
        /// </summary>
        ...
        /// </summary>
        /// <returns>Retorna un string con los datos del instrumento</returns>
        ...
        /// </summary>
        /// <returns>Retorna el metodo Mostrar con los datos del objeto</returns>
